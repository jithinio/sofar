...
Next action: Operator: git push origin main rust-core; then native-core publishing as a Phase 4 decision (operator's call), and confirm origin CI is green on Windows.
