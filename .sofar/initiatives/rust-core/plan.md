...
Next action: When the machine is quiet on AC (or under a stated waiver), run the team100 gate at 226d1a3d; close 4.4 if the official warm session-start p50 is under 20 ms. No push.
