...
## Phase 6 — Silent discards in the plan and phase write path (operator ruling 2026-09-23) [done] — 2/2 done

> Both silent discards fixed in one change (a0bc2e7, D9), and the contract is in SPEC. Installed sessions get the fix only once a release that carries it is published and installed.
