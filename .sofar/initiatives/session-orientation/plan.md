...
Next action: Task 2.1: decide what a fresh session on a bound branch is told about more recent work elsewhere. The record leans to option (b), a line that names the more recent record and stays silent when branch and recent work agree.
