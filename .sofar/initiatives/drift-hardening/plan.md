...
Next action: Phase 5.1: design the guard predicate (glob/grep over touched files + commands, warn-don't-block, no new deps) and log the decision before building doctor/Stop-gate checks.
