...
## Phase 3 — Tier 1: guards first, then reach [active] — 3/5 done
...
Next action: record-index 3.4: `sofar find` + MCP tool traversing from a seed with a hop budget, every result citing its event id.
