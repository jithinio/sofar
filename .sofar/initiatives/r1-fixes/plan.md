...
## Phase 4 — Release [pending] — 1/4 done
...
Next action: 4.3: hand the RC to bench-refresh round 2 — tell rust-core and the bench owner the sha 179b8fd and the pinned path (done by message after this write-back), then support the round-2 addendum freeze (quick-work chain, SOFAR_LESSONS=off arm); 4.4 waits for D19/D20 evidence and is the run owner's publish.
