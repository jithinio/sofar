...
Next action: 4.3 — support the round-2 handoff and the addendum freeze against 179b8fd (quick-work chain, the SOFAR_LESSONS=off arm); when the release after the RC ships, tell sofar-cloud its version in one line (D21). 4.1 waits for bench-refresh 4.1; 2.5 for self-improve 1.2.
