...
Next action: Finish D16 replay: find round 1's 3 L11 calls (r3 S7/S8, r1 S9), write the case file, add `replay` and a compare verdict, test, commit lib/replay.ts. Then run 3.4 with --week-reset.
